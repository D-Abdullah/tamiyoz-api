...
Class Upload {
    ...
    public function Upload_File($filearray, $maxsize = NULL) {
        ...
        if (is_array($filearray) OR ! is_null($filearray[type]) OR ! is_null($filearray[name]) OR ! is_null($filearray[tmp]) OR ! is_null($filearray[size])) {
            ...
            $filearray[place] = $this->CurrentFullPath() . "/" . $this->_uploadfolder . "/";
            $filearray[nplace] = $this->CurrentFullPath() . "/" . $this->_uploadfolder . "/" . $filearray[newname];
            // get file keywords
            ...
            if ($this->is_img($filearray[ext]) and $this->_thumbsimages == true) {
                // the thmbus path
                $filearray[thplace] = $this->CurrentFullPath() . "/" . $this->_uploadfolder . "/thumbs/" . $filearray[newname];
            }
        ...
        //        $this->return_error("هذا الملف ليس من نوع الملفات الذى يتعين ان يكون عليه type=".$this->_fileinfo[type].
       //         " name=".$this->_fileinfo[name]." tmp=".$filearray[tmp]."");
      //      }
...
//$this->return_error($this->_fileinfo[place] . $this->_fileinfo[newname].'||'. $this->_fileinfo[ext].'||'. $this->_fileinfo[thplace].'||'. $this->_th_width.'||'. $this->_th_hight);
